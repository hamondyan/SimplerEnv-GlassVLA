...
# bash scripts/run_glassvla-4b-sam2-text-10k.sh 2>&1 | tee run_glassvla-4b-sam2-text-10k.log
...
for ckpt_path in ${ckpts[@]}; do
    logging_dir=results_glassvla-4b-sam2-text-10k/$(basename $ckpt_path)${action_ensemble_temp}
    mkdir -p $logging_dir
